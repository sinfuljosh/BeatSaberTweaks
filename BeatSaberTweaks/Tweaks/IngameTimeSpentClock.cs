            ...
            while (_Text != null)
            {
                ...
                if (_TimeSpent.Hours == 0)
                {
                    if (_TimeSpent.Minutes == 0)
                        _Text.text = "You played " + string.Format("{0:00}s", _TimeSpent.Seconds) + " this session.";
                    else
                        _Text.text = "You played " + string.Format("{0:00}m {1:00}s", _TimeSpent.Minutes, _TimeSpent.Seconds) + " this session.";
                }
                else
                    _Text.text = "You played " + string.Format("{0:00}h {1:00}m {2:00}s", _TimeSpent.Hours, _TimeSpent.Minutes, _TimeSpent.Seconds) + " this session.";
